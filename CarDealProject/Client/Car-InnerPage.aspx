<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Car-InnerPage.aspx.cs" Inherits="Client_Car_InnerPage" %>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
             ...
             <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="fa fa-sign-in nav-link" id="loginlbl" runat="server" href="Login.aspx">   Login</a>
              </li>
            ...
            <div class="contact-form">
              <form id="contact" action="" runat="server" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <asp:TextBox TextMode="SingleLine" class="form-control" ID="coupan" placeholder="Enter Coupan Code" runat="server" required=""></asp:TextBox>
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                      <asp:Button ID="apply" width="200px"  BackColor="Black" ForeColor="White"  Text="Apply" runat="server" class="border-button" 
                            onclick="apply_Click"></asp:Button>
                    </fieldset>
                  </div>


                  <asp:Label ID="lbl" runat="server" Text="Do You Have Coupan Code?" ForeColor="White"></asp:Label>
                  <div class="col-lg-12">
                    <fieldset>
                      <asp:Button ID="Button1" width="200px"  BackColor="Black" ForeColor="White"  Text="Yes" runat="server" class="border-button" 
                            onclick="yes_Click"></asp:Button>
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                      <asp:Button ID="Button2" width="200px"  BackColor="Black" ForeColor="White"  Text="No" runat="server" class="border-button" 
                            onclick="no_Click"></asp:Button>
                    </fieldset>
                  </div>
                </div>
              </form>
