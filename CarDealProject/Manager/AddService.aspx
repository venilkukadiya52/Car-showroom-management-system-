<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddService.aspx.cs" Inherits="Manager_AddService" %>
            ...
            <div class="card-body">
              ...
              <form id="Form1" runat="server">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <asp:TextBox ID="Sname" required="" class="form-control" runat="server"></asp:TextBox>
                  </div>
                  <label for="inputText" class="col-sm-2 col-form-label">Service Price</label>
                  <div class="col-sm-10">
                    <asp:TextBox ID="Sprice" required="" class="form-control" runat="server"></asp:TextBox>
                  </div>
                  <label for="inputText" class="col-sm-2 col-form-label">Service Description</label>
                  <div class="col-sm-10">
                    <asp:TextBox ID="Sdes" required="" class="form-control" runat="server"></asp:TextBox>
                  </div>
                  <label for="inputText" class="col-sm-2 col-form-label">Service Type</label>
                  <div class="col-sm-10">
                    <asp:DropDownList ID="DropDownList1" runat="server">
                    <asp:ListItem>select</asp:ListItem>
                    <asp:ListItem>INTERIM SERVICE</asp:ListItem>
                    <asp:ListItem>FULL SERVICE</asp:ListItem>
                    </asp:DropDownList>
                      <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                          ControlToValidate="DropDownList1" Display="Dynamic" 
                          ErrorMessage="RequiredFieldValidator" ForeColor="Red" InitialValue="select" 
