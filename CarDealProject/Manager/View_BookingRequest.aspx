<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_BookingRequest.aspx.cs" Inherits="Admin_View_BookingRequest" %>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                       ...
                       <td><a href="buydone.aspx?id=<%# Eval("Booking_Id") %>&email=<%# Eval("Email") %>&name=<%# Eval("Name") %>&user=<%# Eval("Car_Id") %>&cname=<%# Eval("Car_Name") %>">BuyDone</a></td>
                      </tr>
