<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chnagepassword.aspx.cs" Inherits="Manager_chnagepassword" %>
            ...
            <div class="card-body">
              ...
              <form id="Form1" runat="server">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <asp:TextBox ID="txtpass" TextMode="Password" class="form-control" required="" placeholder="Enter Password" runat="server"></asp:TextBox>
                  </div>
                </div>
               <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Confirm Password</label>
                  <div class="col-sm-10">
                    <asp:TextBox ID="txtconpass" TextMode="Password"  class="form-control" required="" placeholder="Enter Confirm Password" runat="server"></asp:TextBox>
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    <asp:Button ID="btnchnage" class="btn btn-primary" runat="server" Text="Update" onclick="btnchnage_Click" 
                         ></asp:Button>
                  </div>
                </div>
