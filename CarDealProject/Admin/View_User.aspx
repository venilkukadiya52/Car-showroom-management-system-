<%@ Page Language="C#" AutoEventWireup="true" CodeFile="View_User.aspx.cs" Inherits="Admin_View_User" %>
      ...
      <form id="Form1" runat="server">
            ...
            <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">View Users Details<span></span></h5>
                  ...
                  <table class="table table-borderless datatable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <th scope="row"><a href="#"><%# Eval("USer_Id") %></a></th>
                        <td><%# Eval("Name") %></td>
                        <td><%# Eval("Email") %></td>
                        <td><%# Eval("City") %></td>
