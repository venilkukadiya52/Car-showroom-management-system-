<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Add_Model.aspx.cs" Inherits="Manager_Add_Model" %>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Add Model Details</h5>
              ...
              <form id="Form1" runat="server">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <asp:DropDownList ID="mname" class="form-control" runat="server"></asp:DropDownList>
                  </div>
                   <label for="inputText" class="col-sm-2 col-form-label">Model Name</label>
                  <div class="col-sm-10">
                    <asp:TextBox ID="modelname" required="" class="form-control" runat="server"></asp:TextBox>
                  </div>
                  <label for="inputText" class="col-sm-2 col-form-label">Model Price</label>
                  <div class="col-sm-10">
                    <asp:TextBox ID="mprice" required="" class="form-control" runat="server"></asp:TextBox>
                  </div>
                 </div>
