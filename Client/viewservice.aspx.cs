...
public partial class Client_viewservice : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        SqlDataAdapter adt = new SqlDataAdapter("select s.*,c.* from tbl_Service1 AS s INNER JOIN tbl_CarDetails AS c ON s.Car_Id=c.Car_Id where s.User_Id='"+Session["userid"]+"'",con);
    ...
    protected void download_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd1 = new SqlCommand("select * from tbl_ServiceCetagory where Service_Type='" + kl + "'", con);
        
        SqlDataAdapter ad1 = new SqlDataAdapter(cmd1);
        DataTable d1 = new DataTable();
        ad1.Fill(d1);
        string ty = d1.Rows[0]["Service_Type"].ToString();
        SqlCommand cmd6 = new SqlCommand("select ss.*,c.* from tbl_Service1 AS ss INNER JOIN tbl_CarDetails AS c ON ss.Car_Id=c.Car_Id where ss.User_Id='" + Session["userid"] + "' and  ss.Service_Type='" + ty + "'", con);
