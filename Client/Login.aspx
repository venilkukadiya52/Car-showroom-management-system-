            ...
            <div class="contact-form">
              <form id="contact" action="" runat="server" method="post">
                <div class="row">
                  <div class="col-lg-12">
                    <fieldset>
                      <asp:TextBox class="form-control" ID="username" TextMode="SingleLine" placeholder="Enter User Name" required="" runat="server" ></asp:TextBox>
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                      <asp:TextBox TextMode="Password" class="form-control" ID="password" placeholder="Enter Password" runat="server" required=""></asp:TextBox>
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                      <asp:Button ID="login" width="200px"  BackColor="Black" ForeColor="White"  Text="Login" runat="server" class="border-button" 
                            onclick="login_Click"></asp:Button>
                    </fieldset>
                      <asp:Label ID="lblerror" runat="server" Text="Invalid UserName or Password!" ForeColor="Red"></asp:Label>
                     <a class="nav-link" style="color: White;" href="Forgotpassword.aspx">Forgot Password?</a>
                     <a class="nav-link" style="color: White;" href="Registration.aspx">Click Here For Registration</a>
                  </div>
                </div>
              </form>
            </div>
