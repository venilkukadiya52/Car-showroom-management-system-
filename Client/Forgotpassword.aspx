            ...
            <div class="contact-form">
              <form id="contact" action="" runat="server" method="post">
                <div class="row">
                  <div class="col-lg-12">
                    <fieldset>
                        <asp:TextBox class="form-control" ID="email" TextMode="SingleLine" placeholder="Enter Your Email" required="" runat="server" ></asp:TextBox>
                    </fieldset>
                  </div>
                  
                  <div class="col-lg-12">
                    <fieldset>
                      <asp:Button ID="forgot" Text="Forgot" runat="server" class="border-button" onclick="forgot_Click" 
                         ></asp:Button>
                    </fieldset>
   ...
   <div class="sub-footer">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p>
                        Copyright © 2022 Car Deal by: <a href="http://localhost:27639/CarDealProject/Client/Index.aspx">cardeal.com</a>
                    </p>
                </div>
            </div>
        </div>
