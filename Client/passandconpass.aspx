<%@ Page Language="C#" AutoEventWireup="true" CodeFile="passandconpass.aspx.cs" Inherits="Client_passandconpass" %>
            ...
            <div class="contact-form">
              <form id="contact" action="" runat="server" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                        <asp:TextBox class="form-control" ID="txtpass" TextMode="Password" placeholder="Enter Password" required="" runat="server" ></asp:TextBox>
                    </fieldset>
                  </div>
                   <div class="col-lg-12">
                    <fieldset>
                        <asp:TextBox class="form-control" ID="txtconpass" TextMode="Password" placeholder="Enter Confirm Password" required="" runat="server" ></asp:TextBox>
                    </fieldset>
                  </div>
                  <div class="col-lg-12">
                    <fieldset>
                      <asp:Button ID="btnupdate" Text="Update" runat="server" class="border-button" onclick="btnupdate_Click1" 
                         ></asp:Button>
                    </fieldset>
                </div>
              </form>
