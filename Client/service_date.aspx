<%@ Page Language="C#" AutoEventWireup="true" CodeFile="service_date.aspx.cs" Inherits="Client_service_date" %>
   ...
   <div class="sub-header">
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container"><a href="Index.aspx"><img id="Img1" runat=server src="~/Client/assets/images/cardeal1.png" style="height:55px" /></a>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-7">
            ...
            ControlToValidate="date" Display="Dynamic" ErrorMessage="CompareValidator" 
            ForeColor="White" Operator="GreaterThanEqual" SetFocusOnError="True" 
            Type="Date">*Select Valid Date</asp:CompareValidator>--%>
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <asp:Button ID="booking" Text="Book" runat="server" class="border-button" 
                            ...
                            <asp:Button ID="down" Text="download BILL" runat="server" class="border-button" 
                            onclick="down_Click"></asp:Button>
                    </fieldset>
                     </div>
                </div>
              </form>
