<%@ Page Language="C#" AutoEventWireup="true" CodeFile="viwebuycar.aspx.cs" Inherits="Client_viwebuycar" %>
...
<body>
                    ...
                    <ItemTemplate>
                        <div class="col-md-4">
                            <div class="contact-item">
                                ...
                                <p>
                                    Date :
                                    <%# Eval("Booking_Date", "{0: dd/MM/yyyy}")%></p>
                                <p>
                                    Fule Type :
                                    <%# Eval("Car_Fule_Type") %></p>
                                <br />
                                <asp:LinkButton ID="Cancle" OnCommand="service" ForeColor="White" class="filled-button"
                                    Text="Take Service" CommandArgument='<%# Eval("Car_Id") %>' runat="server">
                                </asp:LinkButton>
                            </div>
                        </div>
                    </ItemTemplate>
                    ...
                    <ItemTemplate>
                        <div class="col-md-4">
                            <div class="contact-item">
                                ...
                                <p>
                                    Token Amount :
                                    <%# Eval("Booking_Amount")%></p>
                                <p>
                                    Status :
                                    <%# Eval("Booking_Status") %></p>
                                <br />
                            </div>
                        </div>
                    </ItemTemplate>
    ...
    <br />
    <asp:Button ID="Button1" runat="server" class="form-control" Text="View Booked Car"
        OnClick="Button1_Click" />
    <asp:Button ID="Button2" runat="server" class="form-control" Text="View Buy Car" />
    </center>
    </form>
    <br />
    <br />
