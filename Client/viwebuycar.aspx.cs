...
{
    SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename="D:\6 sem\CarDealProject\App_Data\CarDealDB.mdf";Integrated Security=True;Connect Timeout=30");
